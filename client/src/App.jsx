...
function App() {
  ...
  useEffect(()=>{
    ...
    const loadProvider= async()=>{
      if(provider){
        ...
        // Ensure contract exists on current network before wiring up
  ...
  return (
    <> 
      ...
      <div className="App">
        <p className='text-5xl text-white font-black mt-2 md:mt-[100px]'  >Blockchain based</p>
        <p className='text-8xl text-white font-black mt-2 md:mt-[10px]'  >Decentralized Drive</p>
